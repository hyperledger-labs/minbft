...
func makePrepareHandler(id, n uint32, view viewProvider, verifyUI uiVerifier, acceptUI uiAcceptor, handleRequest requestHandler, collectCommit commitCollector, handleGeneratedUIMessage generatedUIMessageHandler, commitUI uiCommitter) prepareHandler {
