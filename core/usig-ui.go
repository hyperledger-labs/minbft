...
//
// The sequential processing is achieved by waiting until uiReleaser
// is invoked on a message with a UI generated by the same replica,
// that has the preceding counter value. The return value new
// indicates if the UI has not been processed before. It is safe to
// invoke concurrently.
...
// unique identifier attached to message.
//
