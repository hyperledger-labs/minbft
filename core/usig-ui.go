...
// is invoked with a UI generated by the same replica, that has the
// preceding counter value. The return value new indicates if the UI
// has not been processed before. It is safe to invoke concurrently.
