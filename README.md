...
Let's restart the network, and keep in mind the process IDs of each
replica process.
...
```sh
$ bin/peer request First request
2019/04/10 02:46:06 Received Reply message from replica 1
2019/04/10 02:46:06 Received Reply message from replica 0
Reply: {"Height":1,"PrevBlockHash":null,"Payload":"Rmlyc3QgcmVxdWVzdA=="}
```
...
$ kill 16916
$ bin/peer request Second request
2019/04/10 02:46:29 Received Reply message from replica 2
2019/04/10 02:46:29 Received Reply message from replica 0
Reply: {"Height":2,"PrevBlockHash":"DuAGbE1hVQCvgi+R0E5zWaKSlVYFEo3CjlRj9Eik5h4=","Payload":"U2Vjb25kIHJlcXVlc3Q="}
```
